...
<body class="animsition">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="{{ URL::asset('template/images/icon/majoo_logo.png') }}" width="60" height="auto" alt="Cool Admin" />
                                <h3>
                                    LOGIN
                                </h3>
                            </a>
    ...
    <script src="{{{ URL::asset('template/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js')}}}"></script>
    <script src="{{{ URL::asset('template/vendor/counter-up/jquery.waypoints.min.js')}}}"></script>
    <script src="{{{ URL::asset('template/vendor/counter-up/jquery.counterup.min.js')}}}"></script>
