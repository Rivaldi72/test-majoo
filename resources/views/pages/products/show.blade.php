                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-4 form-group">
                                        ...
                                        <span class="text-danger text-small" style="font-style: italic;">Kosongkan jika tidak ingin merubah gambar</span>
                                    </div>
                                    <div class="col-6 form-group">
                                        <img id="preview" src="{{ $product->image != null ? URL::asset('upload/products/' . $product->image) : URL::asset('template/images/icon/image-placeholder.png') }}" alt="Preview image" style="max-height: 300px" />
                                    </div>
                                </div>
                                <div class="row">
